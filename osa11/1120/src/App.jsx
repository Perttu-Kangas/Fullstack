...
const App = () => {
  ...
  const [newF, setNewFilter] = useState('')
  ...
  const personsToShow =
    newF.length !== 0
      ? persons.filter((p) => p.name.toLowerCase().includes(newF.toLowerCase()))
      : persons
  ...
  return (
    <div>
      ...
      <Filter newFilter={newF} handleFilterChange={handleFilterChange} />
      <h2>add a new</h2>
      <PersonForm
        newName={newName}
